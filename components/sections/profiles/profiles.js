...
(function () {
  function initProfiles(container) {
    ...
    const prevBtn = container.querySelector(".profiles-nav-btn.prev");
    const nextBtn = container.querySelector(".profiles-nav-btn.next");
  ...
  // Initialize all profile sections
  document.querySelectorAll(".profiles-section").forEach(section => {
    initProfiles(section);
  });
})();
